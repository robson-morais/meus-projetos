package musicPlayer.baseversion;
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (!sair) {
            if (trackList.getTracks().size() != 0) {
                            ...
                            switch (i) {
                                case 1:
                                    while (i != 4) {
                                        ...
                                        switch (i) {
                                            case 1:
                                                String keySong = JOptionPane.showInputDialog(
                                                        "=========================| MusicPlayer |=========================\n" +
                ...
                JOptionPane.showMessageDialog(null, "A lista de tracks precisa ser atualizada para iniciar o sistema.");
                sair = true;
            }
        }
    }
